...
BOOTSTRAP_TENANT_SLUG=entelsat
BOOTSTRAP_TENANT_NAME=Entelsat
BOOTSTRAP_ADMIN_EMAIL=administracion@example.com
BOOTSTRAP_ADMIN_PASSWORD=<secreto robusto de al menos 12 caracteres>
...
(`Europe/Madrid`), `BOOTSTRAP_TOTP_ISSUER` (`Entelsat WiFi`) y
...
El acceso normal sigue realizándose desde `https://wifi.entelsat.com/`; la URI
